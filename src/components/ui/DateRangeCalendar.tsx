...
export function DateRangeCalendar({
  ...
  return (
    <div className={`relative ${className}`} ref={calendarRef}>
      ...
      {isOpen && (
        <div
          className={`absolute ${positionClasses[position]} ${directionClass} z-50 h-[425px] ${calendarWidth} max-w-[calc(100vw-1rem)] rounded-lg bg-white ${compact ? "p-3" : "p-4"} shadow-lg ring-1 ring-gray-200 overflow-y-auto`}
        >
