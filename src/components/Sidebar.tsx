    ...
    <>
      ...
      >
        <div className="relative flex grow flex-col">
          ...
          <nav
            className={mergeClassNames("relative flex flex-1 flex-col", !showUserBlock && "py-4")}
          >
        ...
        <div className={mergeClassNames("-mx-6 mt-auto", isCollapsed && "md:mx-0")}>
          {!showUserBlock ? (
            <div
              className={mergeClassNames(
                "flex items-center px-6 py-3 md:justify-center",
                isCollapsed ? "md:px-2" : "md:justify-end"
              )}
            >
              <Button
                type="button"
