    ...
    private getVoucherDetails(): void {
        ...
        this.route.queryParams.pipe(takeUntil(this.destroyed$)).subscribe((params: any) => {
            if (params?.accountUniqueName) {
                ...
                const request = { accountUniqueName: accountUniqueName, voucherUniqueName: voucherUniqueName?.split(","), companyUniqueName: companyUniqueName, sessionId: this.storeData.session?.id, paymentMethod: PAYMENT_METHODS_ENUM.PAYPAL };
