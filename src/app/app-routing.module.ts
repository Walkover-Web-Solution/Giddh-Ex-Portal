...
const routes: Routes = [
    { path: "page-not-found", loadChildren: () => import('./page-not-found/page-not-found.module').then(module => module.PageNotFoundModule), canActivate: [NeedsAuthentication] },
    ...
    { path: ":companyDomainUniqueName/invoice-pay/account/:accountUniqueName/voucher/:voucherUniqueName", loadChildren: () => import('./invoice-pay/invoice-pay.module').then(module => module.InvoicePayModule), canActivate: [NeedsAuthentication] },
