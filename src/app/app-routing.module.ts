...
const routes: Routes = [
    ...
    { path: ":companyDomainUniqueName/:region/account-statement", loadChildren: () => import('./account-statement/account-statement.module').then(module => module.AccountStatementModule), canActivate: [NeedsAuthentication] },
